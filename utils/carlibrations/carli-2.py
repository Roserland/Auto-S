...
c_w = 6 # corner width
square = 24
img_for_extrinsic = '/Users/fanzw/PycharmProjects/Others/Auto-S-Communications/utils/carlibrations/v-chessboard-1.jpg'
...
if __name__ == '__main__':
    ...
    for fname in glob.glob(os.path.join(imgs_dir_for_calcu_extrinsic, '*2.jpg')):
        img = cv2.imread(fname)
        gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
        ret, corners = cv2.findChessboardCorners(gray, (c_h, c_w), None)
    ...
    detected_tubes_center = [(235.5, 197.5), (317.5, 365.5), (491.5, 287.5), (406.5, 113.5)]
    tube_coords = []
